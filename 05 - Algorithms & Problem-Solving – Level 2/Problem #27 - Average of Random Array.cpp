...
int CalcArraySum(int arr[100], int arrLen)
{
    int Sum = 0;
...
float CalcArrayAvg(int arr[100], int arrLen)
{
    return (float)CalcArraySum(arr, arrLen) / arrLen;
}
...
int main()
{
    ...
    cout << "\n\nAverage Of All Numbers Is : " << CalcArrayAvg(arr1, arr1Len) << endl;
