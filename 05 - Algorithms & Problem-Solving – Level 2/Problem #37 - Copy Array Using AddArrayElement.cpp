...
void CopyArrayUsingAddArrayElement(int arrSource[100], int arrDestination[100], int arrSourceLen, int& arrDestinationLen)
{
...
int main()
{
    ...
    CopyArrayUsingAddArrayElement(arr1, arr2, arr1Len, arr2Len);
